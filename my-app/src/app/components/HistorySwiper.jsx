...
//                 isMiddleSlide(index) ? 'scale-[1.3]' : 'scale-[1]'
//               }`}
//               style={{
//                 maxWidth: '282px',
//                 transformOrigin: 'center',
//                 padding: isMiddleSlide(index) ? '8px' : '0',
//               }}
//             >
//               <Image
//                 src={slide.image}
...
export default function HistorySwiper() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      setPagination(isMobileView); // Set pagination based on screen size
    };
  ...
  return (
    <div className="">
      <Swiper
        ...
        pagination={pagination ? { clickable: true } : false} // Show pagination based on screen size
        onSlideChange={(swiper) => setActiveIndex(swiper.activeIndex)}
        modules={[FreeMode, Pagination, Navigation]}
        className="mySwiper mt-[32px] lg:mt-[80px] mx-[16px] lg:pl-[300px] lg:pr-[17px]"
        breakpoints={{
